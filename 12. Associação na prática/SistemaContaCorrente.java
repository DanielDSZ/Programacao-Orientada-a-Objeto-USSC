...
public class SistemaContaCorrente {
    ...
    public static void main(String[] args) {
        ...
        cta[0].setSaldo(Double.parseDouble(JOptionPane.showInputDialog("Entre com o saldo: R$")));
        cta[0].setCliente(cli[0]);

        //Cadastrar o segundo cliente com uma conta corrente
        cli[1] = new Cliente();
        ...
        cta[1] = new Conta();
        cta[1].setNumero(Integer.parseInt(JOptionPane.showInputDialog("Entre com o Número da Conta: ")));
        ...
        cta[2] = new Conta();
        cta[2].setNumero(Integer.parseInt(JOptionPane.showInputDialog("Entre com o Número da Conta: ")));
